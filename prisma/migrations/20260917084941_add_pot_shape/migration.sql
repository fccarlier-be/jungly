...
INSERT INTO "new_Plant" ("acquiredAt", "createdAt", "exposure", "humidityNote", "id", "libraryEntryId", "locationId", "name", "notes", "photoUrl", "potDiameterMm", "potHeightMm", "potMaterial", "scientificName", "substrate", "temperatureNote", "updatedAt", "userId") SELECT "acquiredAt", "createdAt", "exposure", "humidityNote", "id", "libraryEntryId", "locationId", "name", "notes", "photoUrl", "potDiameterMm", "potHeightMm", "potMaterial", "scientificName", "substrate", "temperatureNote", "updatedAt", "userId" FROM "Plant";
DROP TABLE "Plant";
