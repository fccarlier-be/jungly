...
- **Dépendances** : `next-auth` maintenu à jour manuellement au fil des CVE connues (pas de Dependabot/Renovate configuré) -- vérifier `package.json` reste raisonnablement à jour avant un déploiement public prolongé.
