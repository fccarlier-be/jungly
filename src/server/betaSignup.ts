...
Si vous avez déjà testé Jungly via la PWA sur mon instance privée, supprimez-la avant d'installer la bêta, et créez un nouveau compte dans l'app — les deux ne sont pas liées.
